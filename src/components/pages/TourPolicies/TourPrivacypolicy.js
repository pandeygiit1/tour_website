...
import './TourPolicies.css'
import { Helmet } from 'react-helmet';


const TourPrivacyPolicy = () => {
    return (
        <div>
            {/* <Helmet>
          ...
          <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">
              <div class="breadcrumb-wrap">
                ...
                <p className="text-white">We guarantee a secure journey. It is important for you to familiarize with our privacy policy terms for better tranparency.</p>
              </div>
            </div>
          </div>
        </div>
                    ...
                    <div className="Privacyrow">
                        <div className="Privacy-col-8">
                            <div className="Privacy-rn-faq-item">
                                <div className="Privacy-rn-faq-icon-tour">
